...
class FileTestLog:
    def __init__(self, filename):
        ...
        with open(self._filename, "a") as file:
            file.write("#episode, steps, median_total_rewad, worst_total_rewad, training V_loss, training pi_loss, training pi_entropy, test V_loss, test pi_loss, test pi_entropy, \n")
        #with
    #def
